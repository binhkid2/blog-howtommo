  ...
  return(
    <footer class="w-full pt-10 pb-4">
      ...
      {settings.showLittleSticksPlug && <div>
        <p class="text-center pt-4 flex items-center justify-center">Blog Create by <span class="px-2"><svg fill="none" viewBox="0 0 206 252" height="18px"><path stroke="currentColor" stroke-linecap="round" stroke-width="18.628" d="M10 242.594 135.02 10M196.519 242.595 71.499 10"></path></svg></span><a class="hover:text-underline" href="https://fresh.deno.dev/" target="_blank" rel="noopener">Fresh framwork</a></p>
      </div>}
      </Container>
    </footer>
  )
